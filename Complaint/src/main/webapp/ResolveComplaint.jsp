...
<%@page import="infinite.Complaint.ResolveDAO"%>
<%@page import="infinite.Complaint.Resolve"%>
<%@page import="infinite.Complaint.Complain"%>
<%@page import="infinite.Complaint.ComplainDAO"%>
...
if(request.getParameter("cmpid")!=null){
  ...
  <input type="text" name="cid" value=<%=id %> readonly><br/><br/>
     Complaint Date:
   <input type="text" name="cmpdate" value=<%=date%> readonly><br/><br/>
	Resolve By:
	...
	<%} %>
   <%
   if(request.getParameter("cid")!=null && request.getParameter("cmpdate")!=null){
	   Resolve res=new Resolve();
	   ResolveDAO da=new ResolveDAO();
	   res.setComplaintId(request.getParameter("cid"));
	   String cdate = request.getParameter("cmpdate");
...
%>
<jsp:forward page="ShowComplaint.jsp"></jsp:forward>
<%} %>	   
